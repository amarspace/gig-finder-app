...
// Safe link opener to avoid ERR_BLOCKED_BY_RESPONSE errors
      ...
      <div className="relative rounded-2xl overflow-hidden bg-card shadow-lg animate-scale-in">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/80 via-black/50 to-transparent">
          ...
          <div className="mt-3 flex gap-2">
            <button 
              onClick={(e) => openSocialLink(`https://www.google.com/search?q=${encodeURIComponent(artist)}+official+instagram`, e)}
              className="flex items-center gap-1.5 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white px-3 py-1.5 rounded-full text-xs font-medium hover:opacity-90 transition-opacity"
            >
            ...
            <button 
              onClick={(e) => openSocialLink(`https://www.youtube.com/results?search_query=${encodeURIComponent(artist)}+official+music`, e)}
